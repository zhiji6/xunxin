...
//	 * 等比缩小上传的图片
//	 * @param imgsrc 原图片路径
//	 * @param imgdist 缩略图存放路径
//	 * @param widthdist 生成缩略图宽度
//	 * @param heightdist 生成缩略图高度
//	 */
//	public static boolean reduceImg(String imgsrc, String imgdist, int widthdist,int heightdist) {
//		int imageWidth = 0;   
//		int imageHeight = 0;
//	    try {   
...
//	    	System.out.println("生成文件缩放图时发生异常！");
//	        ex.printStackTrace();
//	        return false;
//	    }   
//	}
