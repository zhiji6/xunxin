...
//var DEFAULT_URL = 'http://192.168.1.99:8080/fybm/static/img/1.pdf';
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = 'hplus/js/plugins/pdf.js/images/';
  PDFJS.workerSrc = 'hplus/js/plugins/pdf.js/pdf.worker.js';
  PDFJS.cMapUrl = 'hplus/js/plugins/pdf.js/cmaps/';
