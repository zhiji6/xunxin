...
<link href="hplus/v3/css/plugins/toastr/toastr.min.css" rel="stylesheet">
</head>
<body class="fixed-sidebar full-height-layout gray-bg">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="hplus/v3/img/profile_small.jpg" /></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <c:forEach items="${item.subMenu}" var="subItem" varStatus="si">
                             <li>
                                <a class="J_menuItem" href="${subItem.MENU_URL}">${subItem.MENU_NAME}</a>
                             </li>
                            </c:forEach>
                        </ul>
                    </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li><span class="m-r-sm text-muted welcome-message"><a href="#" title="返回首页"><i class="fa fa-home"></i></a>欢迎使用H+后台主题UI框架</span>
                        </li>
                        <li class="dropdown">
    ...
    <script src="hplus/v3/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="hplus/v3/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <!-- 自定义js -->
    <script src="hplus/v3/js/hplus.js"></script>
    <script type="text/javascript" src="hplus/v3/js/contabs.js"></script>

    <!-- 第三方插件 -->
    <script src="hplus/v3/js/plugins/pace/pace.min.js"></script>
    <script src="hplus/v3/js/plugins/toastr/toastr.min.js"></script>
    <script>
    //消息序号
    var crtNo = 0;
    var msgType = '';
    var msgTxt = '';
    function getNewMsg(msgNo){
		$.ajax({
			async:true, 
			type: "POST",
			url: '<%=basePath%>user/hasNewMsg.do?msgNo='+msgNo,
			dataType:'text',
			cache: false,
			success: function(data){
				if(data.indexOf('###')!=-1){
					...
					//消息内容
					msgTxt = decodeURI(data.split('###')[1]);
					//消息序号
					crtNo = data.split('###')[2];
					doToast(msgType,msgTxt,'提醒',null);
				}
				if(msgType!='syserror'){
					//递归调用，获取消息
					getNewMsg(crtNo);
