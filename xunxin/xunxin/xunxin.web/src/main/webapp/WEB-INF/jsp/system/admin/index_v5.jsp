        ...
        <div id="page-wrapper" class="gray-bg">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>20%</td>
                                                    <td>2014.11.11</td>
                                                    <td><a href="table_basic.html#" ></i></a>
                                                    </td>
                                                </tr>
                                                <tr>
            ...
            <div class="footer">
                <div class="pull-right">
                    By：<a href="javascript:if(confirm(%27http://www.zi-han.net/  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://www.zi-han.net/%27" >zihan's blog</a>
                </div>
                <div>
