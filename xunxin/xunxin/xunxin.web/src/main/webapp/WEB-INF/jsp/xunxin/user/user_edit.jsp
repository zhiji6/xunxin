            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>用户信息管理 <small>修改</small></h5>
                        <div class="ibox-tools">
                            
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form action="user/saveEdit"  method="post" class="form-horizontal">
                        	<input type="hidden" name="USER_ID" id="user_id" value="${pd.USER_ID }"/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">用户名</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="USERNAME" id="loginname" value="${pd.USERNAME }">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">编号</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="SNUMBER" id="SNUMBER" value="${pd.SNUMBER }" onblur="hasN('${pd.USERNAME }')">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="NAME" id="name" value="${pd.NAME }">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">手机号</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="PHONE" id="PHONE" value="${pd.PHONE }">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">邮箱</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="EMAIL" id="EMAIL" value="${pd.EMAIL }" onblur="hasE('${pd.USERNAME }')">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">所属班组</label>
                                <div class="col-sm-8">
                                    <input type="hidden" class="form-control" name="DEPT_ID" id="DEPT_ID" value="${pd.DEPT_ID}">
                                    <input type="text" class="form-control" name="DEPT_NAME" id="DEPT_NAME" value="${pd.DEPT_NAME}" readonly>
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="BZ" id="BZ" value="${pd.BZ }">
                                </div>
                            </div>
