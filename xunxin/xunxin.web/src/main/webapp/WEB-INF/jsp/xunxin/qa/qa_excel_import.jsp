					...
					<div class="ibox-content">
						<form id="ArticleRotationForm" name="ArticleRotationForm" class="form-horizontal" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" class="form-control required" id="answer1" name="answer1" style="width:500px;" class="form-control" placeholder="ps:非常喜欢" onkeydown="fullInput();"/>
									<input type="text" class="form-control required" id="answer2" name="answer2" style="width:500px;" class="form-control" placeholder="ps:喜欢" onkeydown="fullInput();"/>
									<input type="text" class="form-control required" id="answer3" name="answer3" style="width:500px;" class="form-control" placeholder="ps:一般" onkeydown="fullInput();"/>
									<input type="text" class="form-control required" id="answer4" name="answer4" style="width:500px;" class="form-control" placeholder="ps:不喜欢" onkeydown="fullInput();"/>
									<input type="text" class="form-control required" id="answer5" name="answer5" style="width:500px;" class="form-control" placeholder="ps:厌恶" onkeydown="fullInput();"/>
								</div>
