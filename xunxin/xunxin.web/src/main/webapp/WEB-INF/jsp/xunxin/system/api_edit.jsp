					...
					<div class="ibox-content">
						<form id="ArticleRotationForm" name="ArticleRotationForm" class="form-horizontal" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="api_name" class="form-control required" id="api_name" value="${pd.api_name}" placeholder="接口名称"/>
								</div>
								
								<label class="col-sm-2 control-label">请选择模块：</label>
								<div class="col-sm-2">
									 <select class="form-control" name="api_model" id="api_model" value="${pd.api_model}" style="width:140px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="api_url" class="form-control required" id="api_url" value="${pd.api_url}" placeholder="接口路径"/>
								</div>
							
								<label class="col-sm-2 control-label">API的状态</label>
								<div class="col-sm-2">
									 <select class="form-control" name="api_state" id="api_state" value="${pd.api_state}" style="width:140px;">
							...
							<div class="form-group">
								<div class="form-group">
									<div class="col-sm-2 col-sm-offset-3 text-center" style="margin-top:150px">
										<button id="btn_Save" class="btn btn-primary" type="button" onclick="submitForm();">修改</button>
	...
	<script type="text/javascript">
	    ...
	    function submitForm(){
			...
			var api_state = $("#api_state").val();
           	...
           	$.ajax({
				type: "POST",
				url: '<%=basePath%>api/system/edit_api_document?tm=' +  new Date().getTime(),
				data: {
					"id": id,
					"api_name": api_name,
					"api_model":api_model,
