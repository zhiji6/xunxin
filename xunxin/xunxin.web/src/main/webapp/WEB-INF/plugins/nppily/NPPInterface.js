...
var NPPIF = 
{
	...
	*/
	...
	...
	*/
	SG_CEFSVODFilePlay : function(nc, puHandle, beginTime, endTime, ivIndex, speed, direction, windowHandle)
	{
		return NPPIF.Common.GetNCResponse("SG_CEFSVODFilePlay", nc, puHandle, beginTime, endTime, ivIndex, speed, direction, windowHandle);
	},
	/*
	---
	...
	*/
	...
	{
		return NPPIF.Common.GetNCResponse("SG_FAT32VODFilePlay", nc, puHandle, filePath, speed, direction, relativeStartTime, windowHandle);
	},
	...
	*/
	...
	{
		return NPPIF.Common.GetNCResponse("SG_CEFSDownLoadFile", nc, sgHandle, beginTime, endTime, ivIndex, localSaveAsPath);
	},
	// - 下载CEFS文件系统的图片
	SG_CEFSDownLoadSnapshot : function (nc, sgHandle, snapshotTime, noInSecond, ivIndex, localSaveAsPath)
	{
		return NPPIF.Common.GetNCResponse("SG_CEFSDownLoadSnapshot", nc, sgHandle, snapshotTime, noInSecond, ivIndex, localSaveAsPath);
	},
	// @huzw 2015.05.04
	// - 查询前端存储日期
...
var NrcapError =
{
	...
	NRCAP_ERROR_NC_NOT_LAST_VERSION : 0x0300, // - NC插件不是最新版本
