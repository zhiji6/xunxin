...
function toggleMiniNavbar(obj,act){
	if(act=='add'){
		$(obj).addClass("mini-navbar");
		$(".mini-navbar-show").attr("style","display:inline;");
		$(".mini-navbar-hidden").attr("style","display:none;");
	}else if(act=='remove'){
		$(obj).removeClass("mini-navbar");
		$(".mini-navbar-show").attr("style","display:none;");
		$(".mini-navbar-hidden").attr("style","display:inline;");
	}else if(act=='toggle'){
		if($(obj).hasClass("mini-navbar")){
			$(obj).removeClass("mini-navbar");
			$(".mini-navbar-show").attr("style","display:none;");
			$(".mini-navbar-hidden").attr("style","display:inline;");
		}else{
...
layer.config({
    ...
    $("#side-menu").metisMenu(), $(".right-sidebar-toggle").click(function () {
    	...
    	//toggleMiniNavbar($("body"),"toggle"),SmoothlyMenu()
    }), $(".navbar-minimalize-title").click(function () {
        $("body").toggleClass("mini-navbar"), SmoothlyMenu()
    	//toggleMiniNavbar($("body"),"toggle"),SmoothlyMenu()
	...
	$(this).width() < 769 && (toggleMiniNavbar($("body"),"add"), $(".navbar-static-side").fadeIn());
	//add
	$(this).width() >= 769 && (toggleMiniNavbar($("body"),"remove"),$(".navbar-static-side").fadeIn());
}), $(function () {
    if ($("#fixednavbar").click(function () {
        	...
        	$("#collapsemenu").is(":checked") ? (toggleMiniNavbar($("body"),"add"), SmoothlyMenu(), localStorageSupport && localStorage.setItem("collapse_menu", "on")) : (toggleMiniNavbar($("body"),"remove"), SmoothlyMenu(), localStorageSupport && localStorage.setItem("collapse_menu", "off")) 		
    ...
    if (localStorageSupport) {
        ...
        //"on" == e && (l.hasClass("body-small") || l.addClass("")), "on" == a && ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), l.addClass("fixed-nav")), "on" == o && l.addClass("boxed-layout")
        "on" == e && (l.hasClass("body-small") || toggleMiniNavbar(l,"add")), "on" == a && ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), l.addClass("fixed-nav")), "on" == o && l.addClass("boxed-layout")
    }
});