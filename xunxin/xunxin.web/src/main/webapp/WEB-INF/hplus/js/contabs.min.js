$(function () {
    ...
    function e(e) {
        var a = t($(e).prevAll());
        var i = t($(e).nextAll());
        var n = t($(".content-tabs").children().not(".J_menuTabs"));
    ...
    function o() {
        var closeTab=$(".J_menuTab.active");
        var closeTabId = closeTab.data('id');
        var closeWidth = closeTab.width();
        if(closeTab.children().size()>0){
        	if (closeTab.next(".J_menuTab").size()) {
                var i = closeTab.next(".J_menuTab:eq(0)").data("id");
                closeTab.next(".J_menuTab:eq(0)").addClass("active"), $(".J_mainContent .J_iframe").each(function () {
                    return $(this).data("id") == i ? ($(this).show().siblings(".J_iframe").hide(), !1) : void 0
                });
                var n = parseInt($(".page-tabs-content").css("margin-left"));
                0 > n && $(".page-tabs-content").animate({marginLeft: n + closeWidth + "px"}, "fast"), closeTab.remove(), $(".J_mainContent .J_iframe").each(function () {
                    return $(this).data("id") == closeTabId ? ($(this).remove(), !1) : void 0
                })
            }
            if (closeTab.prev(".J_menuTab").size()) {
                var i = closeTab.prev(".J_menuTab:last").data("id");
                closeTab.prev(".J_menuTab:last").addClass("active"), $(".J_mainContent .J_iframe").each(function () {
                	 return $(this).data("id") == i ? ($(this).show().siblings(".J_iframe").hide(), !1) : void 0
                }), closeTab.parents(".J_menuTab").remove(), $(".J_mainContent .J_iframe").each(function () {
                    return $(this).data("id") == closeTabId ? ($(this).remove(), !1) : void 0
                })
            }
            closeTab.remove();
