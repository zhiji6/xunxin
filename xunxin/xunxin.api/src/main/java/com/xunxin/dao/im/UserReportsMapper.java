...
public interface UserReportsMapper {
	...
	UserReports queryNoInterest(@Param("userId")Integer userId, @Param("anotherId")Integer anotherId);

	void updateNoInterest(@Param("userId")Integer userId, @Param("anotherId")Integer anotherId, @Param("isdelete")Integer isdelete);

	UserReports queryShield(@Param("userId")Integer userId, @Param("anotherId")Integer anotherId);

	List<Integer> findNotInterest(Integer userId);

	void updateShield(@Param("userId")Integer userId, @Param("anotherId")Integer anotherId, @Param("isdelete")Integer isdelete);
}