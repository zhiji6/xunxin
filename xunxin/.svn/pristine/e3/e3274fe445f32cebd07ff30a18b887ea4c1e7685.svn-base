	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>文件上传 <small>编辑</small></h5>
	                        <div class="ibox-tools">
	                        </div>
	                    </div>
	                    <div class="ibox-content">
	                        <form id="filesuploadsForm" name="filesuploadsForm" action="filesUploads/saveEdit"  method="post" class="form-horizontal">
	                        		<input type="hidden" name="ID" id="ID" value="${pd.ID}"/>
	                        	
											<div class="form-group">
				                                <label class="col-sm-2 control-label">文件名</label>
				                                <div class="col-sm-8">
				                                    <input type="text" class="form-control " name="FILE_NAME" id="FILENAME" value="${pd.FILE_NAME }">
				                                </div>
				                            </div>
											<div class="form-group">
				                                <label class="col-sm-2 control-label">basepath</label>
				                                <div class="col-sm-8">
				                                    <input type="text" class="form-control " name="BASE_PATH" id="BASEPATH" value="${pd.BASE_PATH }">
				                                </div>
				                            </div>
											<div class="form-group">
											...
											<div class="form-group">
				                                ...
				                                <div class="col-sm-8" id="datetimepicker">
				                                    <input readonly type="text" class="form-control " name="CREATE_TIME" id="CREATE_TIME"  value="${pd.CREATE_TIME }">
				                                </div>
				                            </div>
