...
function(a, b) {
    ...
    f = {
        ...
        config: function(a, b) {
            ...
            /*tpa=http://www.zi-han.net/theme/hplus/js/plugins/layer/skin/layer.css*/
    ...
    g.pt.vessel = function(a, b) {
        ...
        return f.zIndex = g,
        b([f.shade ? '<div class="layui-layer-shade" id="layui-layer-shade' + d + '" times="' + d + '" style="' + ("z-index:" + (g - 1) + "; background-color:#000000; opacity:" + (f.shade[0] || f.shade) + "; filter:alpha(opacity=" + (100 * f.shade[0] || 100 * f.shade) + ");") + '"></div>': "", '<div class="' + h[0] + " " + (h.anim[f.shift] || "") + (" layui-layer-" + e.type[f.type]) + (0 != f.type && 2 != f.type || f.shade ? "": " layui-layer-border") + " " + (f.skin || "") + '" id="' + h[0] + d + '" type="' + e.type[f.type] + '" times="' + d + '" showtime="' + f.time + '" conType="' + (a ? "object": "string") + '" style="z-index: ' + g + "; width:" + f.area[0] + ";height:" + f.area[1] + (f.fix ? "": ";position:absolute;") + '">' + (a && 2 != f.type ? "": k) + '<div class="layui-layer-content' + (0 == f.type && -1 !== f.icon ? " layui-layer-padding": "") + (3 == f.type ? " layui-layer-loading" + f.icon: "") + '">' + (0 == f.type && -1 !== f.icon ? '<i class="layui-layer-ico layui-layer-ico' + f.icon + '"></i>': "") + (1 == f.type && a ? "": f.content || "") + '</div><span class="layui-layer-setwin">' +
        function() {
    ...
    g.pt.offset = function() {
        ...
        //
        f ? (a.offsetTop = b.offset[0], a.offsetLeft = b.offset[1] || a.offsetLeft) : "auto" !== b.offset && (a.offsetTop = b.offset, "rb" === b.offset && (a.offsetTop = d.height() - e[1], a.offsetLeft = d.width() - e[0]),"lb" === b.offset && (a.offsetTop = d.height() - e[1], a.offsetLeft = 0),"lt" === b.offset && (a.offsetTop =0, a.offsetLeft = 0),"rt" === b.offset && (a.offsetTop = 0, a.offsetLeft =  d.width() - e[0])),
    ...
    g.pt.openLayer = function() {
        ...
        //通过代码调用次函数，可将 layer至于最前
        f.setTopByCall = function(a) {
