...
public interface UserFriendsMapper {
	...
	//查找已关注的人
	List<UserFriends> findOneByUserIdandFriendId(@Param("userId")Integer userId, @Param("another")Integer another);

	void updateByanother(@Param("userId")Integer userId, @Param("another")Integer another, @Param("isDelete")Integer isDelete);
	//查找我的好友
	List<UserFriends> findmyFriend(@Param("userId")Integer userId, @Param("another")Integer another);

	List<UserFriends> findmyFriendIs(@Param("userId")Integer userId, @Param("another")Integer another);
