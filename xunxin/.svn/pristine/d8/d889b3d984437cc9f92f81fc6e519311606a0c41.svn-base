...
<div class="modal-dialog">
	<div class="modal-content animated bounceInRight">
		<div class="modal-header">
			...
			<h1 class="modal-title" style="text-align: -webkit-left;">角色菜单管理</h1>
		</div>
...
<script type="text/javascript">
	...
	function saveMenu() {
		var array = new Array();
		getCheckNodes($('#treeview').treeview('getNode', 0), array);
		$.ajax({
			type : "POST",
			url : 'role/editMenu',
			data : {
