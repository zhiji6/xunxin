						...
						<form id="ArticleRotationForm" name="ArticleRotationForm" class="form-horizontal" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-2" id="answers">
									<input type="text" class="form-control required" id="answer" name="answer" style="width:500px;" class="form-control" placeholder="ps:观点一" />
									<input type="text" class="form-control required" id="answer" name="answer" style="width:500px;" class="form-control" placeholder="ps:观点二" />
									<input type="text" class="form-control required" id="answer" name="answer" style="width:500px;" class="form-control" placeholder="ps:观点三" />
								</div>
