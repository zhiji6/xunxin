...
public class Route {
	...
	public class System {
		...
		public static final String API_MODEL_LIST = "/api_model_list";	//API的模块列表
		public static final String API_STATE_LIST = "/api_state_list";	//API的状态列表
		...
		public static final String SYSTEM_API_VIEW = "/system_api_view";	//接口浏览
		public static final String SYSTEM_API_ADD = "/system_api_add";		//接口新增
		public static final String SYSTEM_API_EDIT = "/system_api_edit";	//接口编辑
	...
	public class QA {
		...
		public static final String QA_QUESTION_MANAGER = "/qa_question_manager";	//Q&A管理
		public static final String FULL_QA_LIST = "/full_qa_list";	//获取 Q&A列表(分页)
		...
		public static final String DELETE_QA_TO_REPERTORY = "/delete_qa_to_repertory";	//编辑删除 Q&A(删除)
		...
		public static final String SPIDER_LINKED_URL = "/spider_linked_url";		//编辑获取外链
		public static final String QA_EDIT = "/qa_edit";	//Q&A编辑
		public static final String QA_VIEW = "/qa_view";	//Q&A浏览
