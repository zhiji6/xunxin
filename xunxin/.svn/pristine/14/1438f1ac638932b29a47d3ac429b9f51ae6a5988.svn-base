...
public class JedisUtil {   
     ...
     static {    
            ...
            //redis未设置了密码：  
//           jedisPool = new JedisPool(config, "192.168.1.122",6379,1000,"xunxin");   
           jedisPool = new JedisPool(config, "39.104.88.178",6379,1000,"xunxin");   
       }  
