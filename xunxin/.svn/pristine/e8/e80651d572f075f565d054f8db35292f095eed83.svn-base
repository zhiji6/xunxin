...
public class APIHttpClient {  
    ...
    * @return 
    */  
   public HttpResponse users_post(String header,String headerValue,String parameters) {  
       ...
       if (method != null & parameters != null  
    	   ...
    	   try {  
               ...
               method.setHeader(header, headerValue);  
    ...
    * @return 
    */  
   public String user_post(String header,String headerValue) {  
	   HttpResponse response = null;
       String body = null;  
       try {  
           // 建立一个NameValuePair数组，用于存储欲传送的参数  
    ...
    * @return 
    */  
   public HttpResponse post(String parameters) {  
	   HttpResponse response = null;
       String body = null;  
       logger.info("parameters:" + parameters);  
