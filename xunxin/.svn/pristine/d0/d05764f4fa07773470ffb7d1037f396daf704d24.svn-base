...
public class MD5_UTIL {
    ...
    public static String decodeMD5(String md5Str) {
    ...
    public static void main(String args[]) {  
        ...
        System.out.println("public_key 解密的：" + decodeMD5(public_key));  
        System.out.println("private_key MD5后：" + string2MD5(private_key));  
        System.out.println("private_key 解密的：" + decodeMD5(private_key));  
