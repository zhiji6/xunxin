		...
		ei = {
			...
			image: function(i) {
				...
				layui.upload({
					...
					type: a,
					success: function(i) {
						0 == i.code ? (i.data = i.data || {}, "images" === a ? ii(n.textarea[0], "img[" + (i.data.imageServer + i.data.srcSlt || "") + "]") : "file" === a && ii(n.textarea[0], "file(" + (i.data.src || "") + ")[" + (i.data.name || "下载文件") + "]"), D("2")) : t.msg(i.msg || "上传失败")
						l.success(i, n, j);
					}
				})
			},
