...
/* 按钮 [[*/
/* 充值页 [[*/
.charge{font-family:Helvetica;padding-bottom:10px;-webkit-user-select:none;margin:20px 20px 20px 20px;}
...
<body>
	<div class="charge">
		...
		<section class="content" >
				<div class="operation" ><a id="100goldCoins" onclick="gold(this)" class="btn-greenOnlick" id="getBrandWCPayRequest" href="#" style="border-radius:25px;font-size:50px;width:45%;height:200px;float:left;color:#ffffff;">100循心币</a></div>
				<div class="operation"><a id="50goldCoins" onclick="gold(this)" class="btn-green" id="getBrandWCPayRequest" href="#" style="border-radius:25px;font-size:50px;width:45%;height:200px;float:right;color:#ff6666;">50循心币</a></div>
		</section>
		 <div class="clear"></div> 
		<section class="content" >
				<div class="operation" style="margin:20px 0px 0px 0px;"><a id="20goldCoins" onclick="gold(this)" class="btn-green" id="getBrandWCPayRequest" href="#" style="border-radius:25px;font-size:50px;width:45%;height:200px;float:left;color:#ff6666;">20循心币</span></a></div>
				<div class="operation"><a id="10goldCoins" onclick="gold(this)" class="btn-green" id="getBrandWCPayRequest" href="#" style="border-radius:25px;font-size:50px;width:45%;height:200px;float:right;color:#ff6666;">10循心币</a></div>
		</section>
		<div class="clear"></div> 
		<div>
		...
		<div class="payMode" style="display:block;">
			...
			<img alt="" src="/plugins/imgs/gou@2x.png" id="zhifubao" style="width:60px;height:60px;margin:30px 30px 20px 20px;float:right;">
			<img alt="" src="/plugins/imgs/gou@3x(1).png" id="zhifubaophoto" style="width:60px;height:60px;margin:30px 30px 20px 20px;float:right;display:none;">
		</div>
		<div class="clear"></div> 
		<hr/>
		<div class="clear"></div> 
		<div class="payModewinxin" style="display:block;">
			...
			<img alt="" src="/plugins/imgs/gou@2x.png" id="weixin" style="width:60px;height:60px;margin:30px 30px 20px 20px;float:right;display:none;">
			<img alt="" src="/plugins/imgs/gou@3x(1).png" id="weixinphoto" style="width:60px;height:60px;margin:30px 30px 20px 20px;float:right;">
		</div>
		<div class="clear"></div> 
		<hr/>
		<div class="clear"></div>
		...
		<div class="clear"></div> 
		<section class="content" >
				<div class="operation" ><span><a onclick="payment(this)" class="btn-greenSubmit" id="getBrandWCPayRequest" href="#" style="border-radius:15px;width:100%;text-align:center;height:130px;color:#ff6666;line-height:150px">立即支付</a></span></div>
		</section>
						<input type="hidden" id="userId" name="userId" value="${userId}">	
						<input type="hidden" id="return"  value="${name}">	
	</div>
	<div id="zhifubaoPay" >
...
/*     var ip = "";
	...
	$(document).ready(function (){
		/* if($("#return").val() == ''){
			window.location.href="FollowHeart://";
		} */
	...
	function payment(obj){
		if (pay==0 ){
			...
			$.ajax({
				type: "POST",
				contentType:"application/x-www-form-urlencoded",
				url: '<%=basePath%>api/pay/ali_pay_h?tm=' +  new Date().getTime(),
				data: {
					userId: $("#userId").val(),
					amount: 0.01
				},
	...
	function weChatPayment(data){
		var url = data.data;
		//$("#urlview").val(url);
		//window.location.href = url+"&redirect_url="+"http%3a%2f%2fwww.xunxinkeji.cn%2fapi%2fuser%2fuser_pay";
		window.location.href = url+"&redirect_url="+"www.xunxinkeji.cn%3a%2f%2fweChatPay";
		//window.location.href = url;
	}
	function aliPayment(data){
		$("#zhifubaoPay").html(data.data);
