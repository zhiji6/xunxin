...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        <form id="ArticleRotationForm" name="ArticleRotationForm" class="form-horizontal" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="name" class="form-control required" name="name" style="width:500px;" class="form-control" placeholder="请输入您要编辑的问题" />
                                </div>
                            ...
                            <div class="form-group" id="linked">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="linked_url" class="form-control required" name="linked_url" style="width:500px;" class="form-control" placeholder="请输入你要搜索的外链" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <!-- 加载编辑器的容器 -->  
                                <script id="container" name="container" style="margin: 0px auto;margin-left:314px;" type="text/plain"> </script>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" id="answers">
                                    <input type="text" class="form-control required" id="answer" name="answer" style="width:800px;" class="form-control" placeholder="ps:观点一" maxlength="40" onkeyup="javascript:setShowLength(this, 40, 'cost_tpl_title_length');"/>
                                    <span class="red" id="cost_tpl_title_length">还可以输入40字数</span> 
                                    <input type="text" class="form-control required" id="answer" name="answer" style="width:800px;" class="form-control" placeholder="ps:观点二" maxlength="40" onkeyup="javascript:setShowLength(this, 40, 'cost_tpl_title_length1');"/>
                                    <span class="red" id="cost_tpl_title_length1">还可以输入40字数</span> 
                                    <input type="text" class="form-control required" id="answer" name="answer" style="width:800px;" class="form-control" placeholder="ps:观点三" maxlength="40" onkeyup="javascript:setShowLength(this, 40, 'cost_tpl_title_length2');"/>
                                    <span class="red" id="cost_tpl_title_length2">还可以输入40字数</span> 
                                </div>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.meta.message == 'ok') {
                        ...
                        var format_v = "<br/><br/><br/><div class=\"form-group\" id=\"clidrenLinked\">"
                            + "<label class=\"col-sm-2 control-label\">" + "Q&A摘要:" + "</label>"
                            + "<div id=\"link\" class=\"col-sm-4\" style=\"border:1px black solid;width:690px;height:318px;margin-left: 12px;border-radius: 10px\" >"
        ...
        function add_answer(){
            ...
            var format_v = "<input type=\"text\" class=\"form-control required\" id=\"answer\" name=\"answer\" style=\"width:800px;\" class=\"form-control\" placeholder=\"ps:观点\" maxlength=\"40\" onkeyup=\"javascript:setShowLength(this, 40, 'cost_tpl_title_length"+ index +"'); \"\" />"
            +"<span class=\"red\" id=\"cost_tpl_title_length"+ index +"\">还可以输入40字数</span>";
