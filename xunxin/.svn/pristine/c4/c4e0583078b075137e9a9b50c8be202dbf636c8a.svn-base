...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="ArticleRotationForm" name="ArticleRotationForm" class="form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                <!-- <span id="inputEditor" class="btn btn-primary" type="button" onclick="inputEditor();">查看原文</span> -->
                                <label class="col-sm-2 control-label">请输入您要上传的内容</label>
                                
                                <!-- 加载编辑器的容器 -->  <%--    --%>
                                <script id="container" name="container" style="margin: 0px auto;margin-left:314px;" value="${pd.HtmlContent}" type="text/plain" >
    ...
    <script type="text/javascript">
        ...
        /* function inputEditor(){
             ...
             console.info(content);
             UE.getEditor('container').setContent(HtmlContent.toString(),true);
        } */
