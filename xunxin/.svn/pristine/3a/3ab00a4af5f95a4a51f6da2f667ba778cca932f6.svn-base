...
/***/ function(module, exports, __webpack_require__) {
	...
	function Trip() {
	  ...
	  this.settings = $.extend({
	    ...
	    onTripChange: $.noop,
	    onTripClose: $.noop,
	    onBeforeTripChange: $.noop,
	    // animation
	  

	    // customizable HTML
	    tripBlockHTML: [
	      '<div class="trip-block" style="border: 1px solid #379082; border-radius: 5px;float:left;vertical-align: top">',
	        
	        '<div style="float:left;">',
		        '<div class="trip-header"></div>',
		        '<div class="trip-content" style="font-family:微软雅黑"></div>',
		        '<div class="trip-progress-wrapper">',
		          '<div class="trip-progress-bar" ></div>',
		          '<a href="#" class="trip-prev" style="font-family:微软雅黑"></a>',
		          '<a href="#" class="trip-next" style="font-family:微软雅黑"></a>',
		        '</div>',
	        '</div>',
	        '<a style="float:left;" href="#" class="trip-close"></a>',
	      '</div>'
	    ]
	  }, userOptions);
	...
	Trip.prototype = {
	   ...
	   * @type {Funtion}
	   */
	  hideExpose: function(needFadeOut) {
	  ...
	  run: function() {
	    ...
	    var beforeTripChange = tripObject.onBeforeTripChange || this.settings.onBeforeTripChange;
	    var tripChange = tripObject.onTripChange || this.settings.onTripChange;
	    beforeTripChange(this.tripIndex, tripObject);
