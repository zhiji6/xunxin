...
/** #########   用户的所有状态      #########  */
	public int                                      onlineTotal;            //月在线时长             
	public int                                      completeness;           //完成度              
	...
	public int										isLogin;                //是否登录  0-在线 1-离线
	public int										ishiden;                //是否冻结  0-冻结 1-正常
	public Integer									messageSetting = 0;          //只接受认证度较高的用户消息  0-关 1-开
	public Integer									selfPortraitSetting = 0;     //只接受初级以上的自画像  0-关 1-开
...
/** #########   基本资料      #########  */
	...
	public Integer getMessageSetting() {
		return messageSetting;
	}

	public void setMessageSetting(Integer messageSetting) {
		this.messageSetting = messageSetting;
	}

	public Integer getSelfPortraitSetting() {
		return selfPortraitSetting;
	}

	public void setSelfPortraitSetting(Integer selfPortraitSetting) {
		this.selfPortraitSetting = selfPortraitSetting;
	}
}
