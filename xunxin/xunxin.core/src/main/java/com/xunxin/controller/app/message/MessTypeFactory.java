...
public class MessTypeFactory {
	...
	public static final Integer REPLY_COMMENT = 15;  //回复的评论
	public static final Integer COMMENT_TOP = 16;  //用户置顶了你的评论
	 ...
	 private MessTypeFactory (){} 
	   ...
	   public  Message getMessage(Integer type){
	      ...
	      }else if(type.equals(9)||type.equals(15)){
