...
//	private static final String AppSecret = "358eb42cb23cd10fa0ab23c23a6253ba";
	 ...
	 * @return
	 */
    public String sesame_initialize(int userId) {
        UserEntity user = appUserService.findById(userId);
        String host = "http://dm-102.data.aliyun.com";
        String path = "/rest/161225/zmxy/api/zhima.customer.certification.initialize.json";
        String method = "POST";
        ...
        Map<String, String> querys = new HashMap<String, String>();
        Map<String, String> bodys = new HashMap<String, String>();
        bodys.put("bizCode", "FACE");
        bodys.put("identityParam", "{\"identity_type\":\"CERT_INFO\",\"cert_type\":\"IDENTITY_CARD\",\"cert_name\":\"" + user.getName() + "\",\"cert_no\":\"" + user.getCertNo() + "\"}");
        try {
            /**
            * 重要提示如下:
            * HttpUtils请从
            ...
            */
            ...
            if(json.getBoolean("success") == true) {
                ...
                String bizNo = object.getString("bizNo");
                return bizNo;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String sesame_certify(String bizNo, String returnUrl) {
        String host = "http://dm-102.data.aliyun.com";
        String path = "/rest/161225/zmxy/api/zhima.customer.certification.certify.json";
        String method = "POST";
        String appcode = AppCode;
        Map<String, String> headers = new HashMap<String, String>();
        //最后在header中的格式(中间是英文空格)为Authorization:APPCODE 83359fd73fe94948385f570e3c139105
